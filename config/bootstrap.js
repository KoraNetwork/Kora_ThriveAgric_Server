...
module.exports.bootstrap = async function(done) {
  ...
  let res = await User.createEach([
    { emailAddress: 'admin@example.com', firstName: 'Ryan', lastName: 'Dahl', isSuperAdmin: true, role:'admin', password: await sails.helpers.passwords.hashPassword('abc123') },
  ]);
